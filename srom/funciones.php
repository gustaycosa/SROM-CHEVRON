    ...
    function Barra(){
        $ptr = '<nav id="navbar" class="navbar navbar-default "> 
            ...
            <ul class="nav navbar-nav AntiFL"> 
                <li class="active"><a href="default">Reporteador EAGLE</a></li> 

                <!--<li><a href="#InxServicios">Servicios</a></li> 
                <li><a href="http://dwh.eimportacion.com.mx/dwh/login.aspx" target="blank">DWH</a></li>
                --> 
...
function GrdRptShort($sGridNomb,$sWsNomb,$aColumnas,$aTitulos){
    ...
    function Webservice(){
        echo "$WebService='http://dwh.eimportacion.com.mx/WEB_SERVICES/DataLogs.asmx?wsdl';";
    }
